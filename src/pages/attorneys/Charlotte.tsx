...
const Attorney3: React.FC = () => {
  return (
    <>
      <Helmet>
        <title>Attorney Name | Law Firm</title>
        <meta name="description" content="Meet Attorney Name, a dedicated attorney at Law Firm, specializing in criminal defense and civil litigation." />
      </Helmet>
          ...
          <Grid item xs={12} md={8}>
            <Paper sx={{ p: 4, mb: 4 }}>
              ...
              <Typography paragraph color="text.secondary">
                Attorney Name is an experienced criminal defense and civil litigation attorney at Law Firm. They are passionate about defending clients' rights and achieving the best possible outcomes. Attorney Name is active in the local community and enjoys outdoor activities.
              </Typography>
            </Paper>
          </Grid>
        </Grid>
